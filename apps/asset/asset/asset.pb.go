...
var file_asset_proto_rawDesc = []byte{
	...
	0xbe, 0x01, 0x0a, 0x05, 0x41, 0x73, 0x73, 0x65, 0x74, 0x12, 0x3c, 0x0a, 0x0b, 0x43, 0x72, 0x65,
...
var file_asset_proto_depIdxs = []int32{
	...
	1, // 4: asset.Asset.CreateAsset:output_type -> asset.CreateAssetResp
	3, // 5: asset.Asset.CreateProject:output_type -> asset.ProjectResp
	5, // 6: asset.Asset.GetProjectList:output_type -> asset.ProjectListResp
